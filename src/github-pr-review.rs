...
async fn handler(
    ...
    if new_commit {
        ...
        match issues.create_comment(pull_number, "Hello, I am a code review bot.It could take a few minutes for me to do code review for this PR. Please check back later. Thanks!").await {
            Ok(comment) => {
